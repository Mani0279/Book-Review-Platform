...
const EditBook = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await bookAPI.updateBook(id, {
        ...formData,
  ...
  return (
    <div style={styles.container}>
      <div style={styles.formCard}>
        <Link to={`/books/${id}`} style={styles.backLink}>
          ← Back to Book Details
        </Link>

        <h2 style={styles.title}>Edit Book</h2>
        <p style={styles.subtitle}>Update book information</p>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          <div style={styles.buttonGroup}>
            ...
            <Link to={`/books/${id}`} style={styles.cancelButton}>
              Cancel
            </Link>
          </div>
        </form>
